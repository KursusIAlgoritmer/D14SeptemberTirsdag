...
//
//Note : 
//the algorithms and data structures that we introduce in Chapter 3 make it possible to develop an 
//implementation that can guarantee that both insert() and delete() take time prortional to the 
//logarithm of the number of items in the queue—see Exercise 3.5.27.

public class Exc1_3_38{
